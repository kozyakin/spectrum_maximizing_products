...
dx = [0.12, 0.12, 0.12, 0.0, 0.0, -0.12,
      -0.12, -0.12, -0.12, 0.0, 0.0, 0.13]
...
adx = [0.08, 0.08, -0.04, -0.1, -0.1, -0.1,
       -0.08, -0.06, 0.08, 0.12, 0.12, 0.12]
ady = [-0.07, -0.08, -0.08, 0.04, 0.0, 0.0,
...
bdx = [0.02, 0.08, 0.0, -0.06, -0.1, -0.1,
       -0.04, -0.06, 0.0, 0.1, 0.13, 0.12]
bdy = [-0.1, -0.1, 0.08, -0.08, 0.0, 0.05,
       0.08, 0.08, -0.1, 0.08, 0.0, -0.05]
for i, label in enumerate(labels):
