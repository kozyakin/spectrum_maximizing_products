...
adx = [0.07, 0.0, -0.04, -0.08, -0.1, -0.1,
       -0.08, -0.04, 0.08, 0.1, 0.12, 0.13]
ady = [-0.06, -0.08, -0.08, -0.08, 0.0, 0.0,
       0.06, 0.1, 0.1, 0.1, 0.0, 0.0]
for i, label in enumerate(labels):
...
bdx = [0.1, 0.0, -0.02, -0.06, -0.1, -0.1,
       -0.1, -0.04, 0.0, 0.11, 0.13, 0.12]
bdy = [-0.06, -0.1, -0.1, -0.08, 0.0, 0.05,
       0.05, 0.1, 0.1, 0.06, 0.0, -0.05]
for i, label in enumerate(labels):
