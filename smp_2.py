...
dx = [0.12, 0.12, 0.08, 0.08, 0.0, -0.12,
      -0.12, -0.1, -0.1, 0.0, 0.0, 0.13]
dy = [0.0, -0.08, -0.1, -0.08, -0.08, 0.0,
      0.0, 0.08, 0.08, 0.1, 0.1, 0.0]
...
adx = [0.08, 0.08, -0.07, -0.1, -0.1, -0.1,
       -0.08, -0.06, 0.08, 0.12, 0.13, 0.13]
ady = [-0.07, -0.08, -0.1, 0.04, 0.0, 0.0,
       0.07, 0.08, 0.1, -0.02, 0.0, 0.0]
for i, label in enumerate(labels):
...
bdx = [0.02, 0.08, 0.0, -0.06, -0.1, -0.1,
       -0.01, -0.06, 0.0, 0.1, 0.13, 0.12]
bdy = [-0.11, -0.1, 0.08, -0.08, 0.0, 0.05,
       0.11, 0.08, -0.1, 0.08, 0.0, -0.05]
for i, label in enumerate(labels):
