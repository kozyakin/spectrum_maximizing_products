...
Last updated on Sat Jul 6 22:55:41 2024 +0300
...
A = np.asarray([[COS_THETA, -(1 / LAMBDA) * SIN_THETA],
                [LAMBDA * SIN_THETA, COS_THETA]])
B = np.asarray([[COS_THETA, -LAMBDA * SIN_THETA],
                [(1 / LAMBDA) * SIN_THETA, COS_THETA]])
