...
% This is patched version of jsr_norm_balancedRealPolytope.m from 
% JSR Toolbox for correcting incompatibility with recend versions of the 
% function linprog(...) introduced in MATLAB R2023a.
%
% Patched by V. Kozyakin on 23.05.2024 10:01:40
%
...
% Next is the patched version of previous line (VK)
options = optimset('Display', 'off', 'Algorithm', 'interior-point','TolFun', 1e-12);
m = length(M);
N = size(M{1}, 1);
F = M;
