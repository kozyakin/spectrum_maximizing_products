...
dx = [0.1, 0.1, 0.1, 0.0, 0.0, -0.1,
      -0.1, -0.1, -0.1, 0.0, 0.0, 0.12]
dy = [0.0, 0.0, 0.0, -0.09, -0.09, 0.0,
      0.0, 0.0, 0.0, 0.09, 0.09, 0.0]
...
adx = [0.07, 0.0, -0.04, -0.08, -0.08, -0.09,
       -0.08, -0.04, 0.06, 0.12, 0.13, 0.12]
ady = [-0.07, -0.09, -0.07, 0.0, 0.0, 0.0,
       0.06, 0.08, 0.08, 0.0, 0.0, 0.0]
for i, label in enumerate(labels):
...
bdx = [0.1, 0.08, -0.02, -0.06, -0.1, -0.1,
       -0.1, -0.06, 0.04, 0.1, 0.12, 0.12]
bdy = [-0.05, -0.1, -0.1, -0.08, 0.0, 0.05,
       0.05, 0.08, 0.08, 0.05, 0.0, -0.05]
for i, label in enumerate(labels):
